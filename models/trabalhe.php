...
require(SYSBASE."templates/".TEMPLATE."/common/header.php"); ?>
           ...
           <div class="empregos">
            ...
            <!-- BREADCRUMBS / CAMINHO EXIBIDO -->
            <div class="breadcrumbs">
                <div class="container">
                    <span>
                        <a class="contato" href="<?php echo DOCBASE.LANG_ALIAS; ?>" title="<?php echo $homepage['title']; ?>"><?php echo $homepage['name']; ?></a>
                    </span>
                    <span>
                    <span>
                        <!-- <?php echo $texts['PAGINA_NOTICIAS']; ?></span> -->
...
<div class="row margin-bottom-25">
            ...
            <div class = "vagas">
            <!--h2> Vagas Dispon&iacute;veis:</h2--!>
            <p> No momento n&atilde;o h&aacute; vagas dispon&iacute;veis. Clique <a href="/pt/contato"><b>aqui</b></a> para acessar a p&aacute;gina de contato.</p>
            </div><!-- DIV DE TESTE -->
